...
<ol>
   ...
   <li>Smart Contract Ownership Transfer: Will run the TranferOwnership function using the buyer address and send the scid as a comment. Ensure that you use inventory of one! Sometimes the ownership change is reflected in gnomen, not sure of the specifics there yet.</li>
</ol>
<p>
